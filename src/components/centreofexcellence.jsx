...
const excellenceData = [
  { id: 1, title: "Cardiology", description: "Comprehensive cardiac care led by experienced cardiologists and advanced diagnostic tools.", image: Heart, services: ["Coronary Angiography", "Pacemaker Implantation", "Peripheral Vascular Stenting", "Complex Heart Surgeries", "Preventive Cardiology", "Non-Invasive Cardiology", "Coronary Angioplasty", "Paediatric Cardiology"] },
  { id: 2, title: "Pulmonology", description: "Advanced care and diagnosis for all your pulmonary needs, from diagnosis to recovery.", image: Lungs, services: ["Asthma", "Tuberculosis (TB)", "Pneumonia", "Interstitial Lung Disease", "Paediatric Pulmonology", "Pulmonology Surgeries", "Fungal & bacterial lung infections", "Chronic Obstructive Pulmonary Disease (COPD)"] },
  { id: 3, title: "Mother & Child Care", description: "Expert-led services for mothers and babies, from prenatal assessments to delivery and neonatal care.", image: Mother, services: ["Pre-natal Care", "Post-natal Care", "Paediatrics", "Maternity Care", "Gynaecology", "Maternity", "Painless Delivery", "Dietetics"] },
  { id: 4, title: "Cancer Center", description: "Comprehensive cancer diagnosis and treatment led by expert oncologists using advanced technologies in a compassionate setting.", image: Cancercentre, services: ["Brain Cancer", "Breast Cancer", "Cervical Cancer", "Colorectal Cancer", "Endometrial Cancer", "Lung Cancer", "Lymphoma Cancer", "Renal Cancer"] },
  { id: 5, title: "Neurology", description: "Comprehensive neurological support with cutting-edge evaluation and compassionate care.", image: Brain, services: ["Skull Base Surgery", "Paediatric Neurology", "Neurosurgery", "Epilepsy Surgeries", "Stereotactic Surgery", "Stroke Evaluation", "Micro Neurosurgical Tumour Removal", "Keyhole Brain Biopsy"] },
  { id: 6, title: "Fertility Centre", description: "Advanced fertility treatments and diagnostics, supporting couples in every stage of their parenthood journey with care.", image: Fertility, services: ["IVF", "IUI", "ICSI", "Fertility Checkup", "PCOD & PCOS", "Laparoscopy", "Male Infertility", "Female Infertility"] },
];
...
export default function CentreOfExcellence() {
  ...
  const settings = {
    ...
    slidesToScroll: 2,
    rows: 2,
    arrows: false, // disable slick default arrows
    responsive: [
      {
        breakpoint: 1024,
        ...
        <Slider ref={sliderRef} {...settings}>
          {excellenceData.map((item) => (
            <div key={item.id} className="p-4 h-[100%]">
              <div className="bg-white rounded-3xl p-6 sm:p-8 h-[300px] mb-custom-h flex flex-col relative">
                {/* Top-right Icon */}
