...
import Banner from "@/assets/specialites/diagnostic-service/diagnostic-banner.webp";
...
import "./imaginganddiagnosticservices.css";
...
const breadcrumbItems = [
  ...
  { label: "Imaging and Diagnostic Services", href: "/specialities/imaging-and-diagnostic-services" },
];

function Imaginganddiagnosticservices() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
      ...
      <section className="relative px-7 hero-section -mt-28 mb-hero-section">
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            >
              Best Imaging and Diagnostic Services in Erode
            </motion.h1>
            ...
            >
              Where Advanced Technology Meets Accurate Diagnosis 
            </motion.p>
...
export default Imaginganddiagnosticservices;
