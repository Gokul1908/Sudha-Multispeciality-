...
import aboutOverview from "@/assets/specialites/diagnostic-service/diagnostic-service.webp";
  ...
  },
  {
    ...
    content: (
      <div className="text-sm space-y-3">
        <div>
          <ul className="space-y-4">
            <li className="flex items-center gap-2 text-[14px] font-semibold">  <Image src={Checklight} alt="tick" width={24} height={24} />Real-time, non-invasive fetal and organ imaging</li>
...

  {
    ...
    content: (
      <div className="text-sm text-gray-700 space-y-3">
        <div>
          <ul className="space-y-4">
            <li className="flex items-center gap-2 text-[14px] font-semibold">  <Image src={Checklight} alt="tick" width={24} height={24} />Ortho: Bone fractures, joint issues</li>
            <li className="flex items-center gap-2 text-[14px] font-semibold"> <Image src={Checklight} alt="tick" width={24} height={24} /> Cardio: Chest X-ray for heart and lung </li>
            <li className="flex items-center gap-2 text-[14px] font-semibold"><Image src={Checklight} alt="tick" width={24} height={24} /> ENT: Ear, nose, and throat imaging</li>
            <li className="flex items-center gap-2 text-[14px] font-semibold"><Image src={Checklight} alt="tick" width={24} height={24} />Dental: Jaw, teeth, and sinus evaluation</li>
      ...
      <aside className="w-full lg:w-1/3 lg:sticky top-24 h-fit space-y-6">
        ...
        >
          ...
          <ul className="space-y-4 text-start mt-4">
            <li className="flex items-start  gap-1 text-[14px] font-semibold">  <Image className="mt-1" src={Checklight} alt="tick" width={12} height={10} /> 24/7 access to advanced diagnostic services under one roof</li>
            <li className="flex items-start  gap-1 text-[14px] font-semibold">  <Image className="mt-1" src={Checklight} alt="tick" width={12} height={10} /> Accurate and timely reports ensured by expert radiology team</li>
            <li className="flex items-start  gap-1 text-[14px] font-semibold">  <Image className="mt-1" src={Checklight} alt="tick" width={12} height={10} />Integrated support for all departments to speed up treatment decisions</li>
