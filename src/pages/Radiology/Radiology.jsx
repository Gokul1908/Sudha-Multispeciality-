...
import Banner from "@/assets/specialites/radiology/radiology-banner.webp";
...
const breadcrumbItems = [
  ...
  { label: "Radiology", href: "/specialities/radiology" },
];
      ...
      <section className="relative px-7 hero-section -mt-28 mb-hero-section">
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            >
              Advanced Diagnosis Through Precision Imaging
            </motion.p>
