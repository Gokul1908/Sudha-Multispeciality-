      ...
      <div className="text-sm text-gray-700 space-y-3">
        ...
        <div>
          <ul className="space-y-4">
            ...
            <li className="flex items-center gap-2 text-[14px] font-semibold"> <Image src={Checklight} alt="tick" width={24} height={24} /> 3D/4D USG Scan with Colour Doppler </li>
            <li className="flex items-center gap-2 text-[14px] font-semibold"><Image src={Checklight} alt="tick" width={24} height={24} /> OPG, RVG, and Intraoral RVG </li>
            <li className="flex items-center gap-2 text-[14px] font-semibold"><Image src={Checklight} alt="tick" width={24} height={24} /> Echocardiography and Mammography </li>
          </ul>
