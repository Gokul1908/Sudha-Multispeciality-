...
import Banner from "@/assets/specialites/neonatology/neonatology-banner.webp";
...
const breadcrumbItems = [
  ...
  { label: "Laryngology", href: "/specialities/laryngology" },
];

function Laryngology() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
      ...
      <section className="relative px-7 hero-section -mt-28 mb-hero-section">
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            >
              Precision Care for Throat and Voice Wellness.
            </motion.p>
