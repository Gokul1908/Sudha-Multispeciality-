...
import Banner from "@/assets/alliedhealthservice/nursingservices/nursingservices.webp";
...
const breadcrumbItems = [
  ...
  { label: "Nursing Services ", href: "/nursing-service " },
];


function nursingservices() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
      ...
      <section className="relative px-7 hero-section -mt-28 mb-hero-section">
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            >
              Because Every Patient Deserves the Best Care
            </motion.p>
