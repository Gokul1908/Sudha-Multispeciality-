      ...
      <section className="relative px-7 hero-section -mt-28 mb-hero-section">
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            >
              Supporting You with Advanced Painless Delivery Care. 
            </motion.p>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
          ...
          <div className="relative w-full lg:w-1/2 mx-auto rounded-2xl overflow-hidden">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 bg-white/80 p-6 w-[90%] bottom-10 flex flex-col items-center justify-end rounded-2xl">
              ...
              <button className="btn-diagonal inline-flex items-center text-white bg-[#2B3990] hover:bg-[#1e2a70] px-7 py-3 rounded-full text-sm font-medium">
...
export default PainLessDelivery;
